<template>
    ...
    <div
        ...
        :class="{'ios-app-layout':iosAppLayoutHeight,'ios-app-bangs-layout-02-03':isBangsScreenForIos(),'ios-app-02-03-version-10':iosApp0203version10(),'app-layout-container':$config.newUserFromType()==1}"
    >
