<template>
    ...
    >
        ...
        >
            ...
            <SideSpace value="0.48rem" style="margin-top:2rem">
                <div slot="content">
                    <section class="header">
                        <h2 class="header-title">服务授权</h2>
                        <p class="header-title-info">本服务由IAI Trade提供，请登录或切换至平台方真实账户，授权“AI智能盯盘”绑定账号，绑定后可使用盯盘服务。</p>
                    </section>
                    <div class="login-form">
                        <!-- 确定按钮 -->
                         <button
                                class="login-btn common-button-style01"
                                 @click="loginSubmit"
                            >
                            登录并授权
                         </button>
